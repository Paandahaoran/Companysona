...
- 答题：25 题，V2.3 四选一场景题，一屏一题，覆盖汇报、协作、服务对象、制度流程、情绪劳动、临场判断、内容包装
- 算法：四维连续分数 + 场景偏好 + 人格 bonus + 17 个公司/社会职业人格坐标匹配
...
- 完测率：`complete / start`，可用 `payload->>'app_version' = 'v2.3'` 区分 V2.3
